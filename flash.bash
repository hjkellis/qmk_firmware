# commands to setup qmk environment
pip install qmk
qmk setup
...
# avrdude -p atmega32u4 -c avr109 -P /dev/ttyACM0 -b 57600 -D -U flash:w:./qmk_firmware/.build/custom_scylla_promicro_default.hex:i
